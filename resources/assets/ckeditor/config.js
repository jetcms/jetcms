...
CKEDITOR.editorConfig = function (config) {
	...
	config.toolbarGroups = [
		...
		'/',
		{ name: 'basicstyles'},
		{ name: 'insert', groups: ['insert', 'others','FontAwesome', 'Source'] },
		{ name: 'links'},
...
*/
	...
	config.extraPlugins = 'lineutils,widget,div,codesnippet,widgetbootstrap,pbckcode,codemirror,forms,fakeobjects';
